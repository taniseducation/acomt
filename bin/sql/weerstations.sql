...
--
-- Machine: rdbms
-- Gegenereerd op: 18 jul 2017 om 11:34
...
--
-- Tabelstructuur voor tabel `inzet`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `inzet`
--
...
--
-- Tabelstructuur voor tabel `meters`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `meters`
--
...
--
-- Indexen voor tabel `inzet`
--
ALTER TABLE `inzet`
 ADD PRIMARY KEY (`m_code`);

--
-- Indexen voor tabel `meters`
--
ALTER TABLE `meters`
...
--
-- AUTO_INCREMENT voor een tabel `inzet`
--
ALTER TABLE `inzet`
MODIFY `m_code` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3925;
--
-- AUTO_INCREMENT voor een tabel `meters`
--
ALTER TABLE `meters`
